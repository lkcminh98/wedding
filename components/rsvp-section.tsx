          ...
          >
            ...
            {formData.attending === "yes" && (
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="guests" className="text-xs tracking-wider uppercase text-muted-foreground">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="attendingVenue" className="text-xs tracking-wider uppercase text-muted-foreground">
                      {LABELS.attendingEvent}
                    </Label>
                    <select
                      id="attendingVenue"
                      value={formData.attendingVenue}
                      onChange={(e) => setFormData({ ...formData, attendingVenue: e.target.value })}
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className="bg-background border-border focus:border-foreground/30 min-h-[120px] resize-none"
              />
            </div>
